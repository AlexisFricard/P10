...
def test_if_request_categories_return_exptected_datas(monkeypatch):
    ...
    class MockResponse:
        def json(*args, **kwargs):
            mock_url = "purbeurre/webapp/modules/api/tests/mocks/mock_categories.json"  # noqa
...
def test_if_request_code_return_exptected_datas(monkeypatch):
    ...
    class MockResponse:
        def json(*args, **kwargs):
            mock_url = (
                "purbeurre/webapp/modules/api/tests/mocks/mock_code.json"  # noqa
            )
            with open(mock_url, encoding="utf-8") as json_file:
                mock_resp = json.load(json_file)
            return mock_resp
...
def test_if_request_products_return_none_or_datas(monkeypatch):
    ...
    class MockResponse:
        def json(*args, **kwargs):
            mock_url = (
                "purbeurre/webapp/modules/api/tests/mocks/mock_products.json"  # noqa
            )
            with open(mock_url, encoding="utf-8") as json_file:
                mock_resp = json.load(json_file)
            return mock_resp
...
def test_if_request_categ_return_none_or_datas(monkeypatch):
    ...
    class MockResponse:
        def json(*args, **kwargs):
            mock_url = (
                "purbeurre/webapp/modules/api/tests/mocks/mock_by_categ.json"  # noqa
            )
            with open(mock_url, encoding="utf-8") as json_file:
                mock_resp = json.load(json_file)
            return mock_resp
